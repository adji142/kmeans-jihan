                      ...
                      <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="Nama" id="Nama" required="" placeholder="Nama Kecamatan" class="form-control ">
                        ...
                        <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Luas Panen<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 ">
                            <input type="number" name="LuasPanen" id="LuasPanen" required="" placeholder="Luas Panen" class="form-control " >
                          </div>
                        </div>
                        <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Produksi<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 ">
                            <input type="number" name="Produksi" id="Produksi" required="" placeholder="Produksi" class="form-control " >
                          </div>
                        </div>
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            ...
                            <input type="text" name="Koordinat" id="Koordinat" required="" placeholder="Koordinat" class="form-control ">
                          </div>
                        </div>
                        <div class="item form-group">
                          <div class="col-md-12 col-sm-12 ">
      ...
      $.ajax({
            ...
            success: function (response) {
              $.each(response.data,function (k,v) {
                ...
                $('#LuasPanen').val(v.LuasPanen);
                $('#Produksi').val(v.Produksi);
                $('#Kelompok').val(v.Kelompok).change();
