      ...
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <div class="row">
          <div class="col-lg-12 col-md-12 text-left about-two-grids">
            <h3 class="title  mb-md-4 mb-sm-3 mb-3">SISTEM INFORMASI GEOGRAFIS PEMETAAN PANEN BUAH DI SRAGEN DENGAN METODE K MEANS CLUSTERING</h3>

            <input type="hidden" name="Alamat" id="Alamat">
            <div class="col-lg-6 col-md-6">
              <!-- <div id="filterdata"></div> -->
              <select name='Kelompok' id='Kelompok' class='form-control'><option value='MANGGA'>MANGGA</option><option value='PEPAYA'>PEPAYA</option></select> <button class='btn btn-primary' id='bt_Search'>Search</button>
            </div>
            <br>
