                ...
                <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="number" name="LuasPanen" id="LuasPanen" required="" placeholder="Luas Panen" class="form-control " step="0.0001">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <input type="number" name="Produksi" id="Produksi" required="" placeholder="Produksi" class="form-control " step="0.0001">
                    </div>
                  </div>
                  <div class="item" form-group>
